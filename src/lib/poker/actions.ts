...
export async function createPokerSession(input: CreatePokerSessionInput) {
  ...
  // Note: unique_url is intentionally omitted - it will be auto-generated by the
  // database trigger (set_unique_url) which handles NULL/empty values.
  // Using @ts-expect-error to bypass TypeScript's requirement for the field.
  // @ts-expect-error - unique_url is auto-generated by database trigger
