...
export async function createPokerSession(input: CreatePokerSessionInput) {
  ...
  // Note: unique_url is set to empty string - the database trigger (set_unique_url)
  // will auto-generate a unique URL when it detects NULL or empty string.
  const { data: session, error: sessionError } = await supabase
    ...
    .insert({
      ...
      unique_url: "", // Auto-generated by DB trigger
